...
const category_phones = () => {
  return (
    <div className="container mx-auto px-6 md:px-32 my-8">
      <h1 className="text-3xl font-bold mb-6">Phones</h1>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {newproductsData
          .filter((product) => product.id >= 14 && product.id <= 18) // Filter products with IDs from 0 to 4
          .map((product) => (
            <ProductCard
...
export default category_phones
